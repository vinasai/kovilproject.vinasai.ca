        ...
        <div className="bg-white text-black text-center py-2 text-sm md:text-base flex justify-center items-center gap-4 px-4">
          ...
          <div className="absolute right-4">
            <a 
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-1 md:px-4 md:py-2 rounded-lg shadow-md transition-all duration-300 whitespace-nowrap text-sm md:text-base"
            >
              Admin Registration
            </a>
          </div>
