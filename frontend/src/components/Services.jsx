    ...
    <section className="py-10 bg-gray-100">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 mt-4">
          Our temple provides a wide range of prayer services in the form of
          Archana/Aarthi, Abishekam, and Homas. Archana can be performed on a
          daily basis both morning and evening.
          <br />
          <strong>
            Abishekam’s and Pirasatham’s bookings need to be pre-booked 1 day
            prior to the service date.
          </strong>
          Special services such as Homams and Weddings are only booked through
          phone.
